    ...
    <div class="container">
        ...
        <nav class="nav">
            ...
            <ul class="nav-list">
                ...
                <li class="lsit-item"><a href="<?= BASE_URL ?>add_courses.php">Courses</a></li>
                <li class="lsit-item"><a href="<?= BASE_URL ?>add_freelancer.php">Freelance</a></li>
                <li class="lsit-item"><a href="<?= BASE_URL ?>add_local.php">Local Services</a></li>
